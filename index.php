...
<head>
  ...
  <link rel="stylesheet" media="(max-width: 599px)" href="css/style-mobile.css">
</head>

<body>
  <?php include('includes/php/header-hero.php'); ?>
  ...
  <main>
    ...
    <section class="resumo">
      <div class="container">
        <div class="row descricao">
          <div class="col-sm-12 align-self-baseline">
            ...
            <p class="descricao-empresa" data-aos="fade-up" data-aos-duration="2000">Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque, soluta
              eveniet suscipit provident, porro ea minus possimus eum vel doloribus laudantium non quos at quasi
              quibusdam
              reprehenderit amet facilis ullam! Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae
              asperiores quidem optio dicta, assumenda in, porro, ullam doloribus inventore quas nobis dolores iste?
              Mollitia vitae dolorum magni, qui ratione dolorem? Lorem ipsum, dolor sit amet consectetur adipisicing
              elit. Quo iusto culpa iste dicta voluptate quae dolorum quasi quidem! Vel quis deleniti corporis
              quibusdam omnis tempora dolores cupiditate sint harum tenetur? Lorem ipsum dolor sit amet consectetur
              adipisicing elit. Sint provident sit deserunt repellat cumque beatae facere, explicabo repudiandae
              expedita ut quas voluptas placeat harum ad. Quam et quisquam mollitia tempora? placeat harum ad. Quam et
              quisquam mollitia tempora? placeat harum ad. Quam et quisquam mollitia
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="videos concord" id="concord-cards">
      <div class="container-fluid-videos text-center" style="padding-top: 10px;">
        <div class="col-sm-12">
          <h2 class="text-center text-black header-wrapper" data-aos="fade-up" data-aos-duration="1000">
            Expertise em Ação
          </h2>
          <hr class="divider" data-aos="fade-up" data-aos-duration="2000">
          </hr>
        </div>
        <a class="bmd-modalButton" data-toggle="modal" data-bmdSrc="video/Business_chart_finger1.mp4"
          data-target="#myModal" data-bmdVideoFullscreen="true">
          <div class="card x" data-aos="fade-up" data-aos-duration="2000">
            <section class="wrapper">
              <img style="background-color: #f4a919; background-image: url(images/video-bg.jpg)" alt=""></img>
              <header class="card-title">
                <h6>Dicas</h6>
              </header>
              <footer class="card-footer  " style="background: white;">
                <h6>Mario Trentim</h6>
                <h5>Ferramentas de produtividade</h5>
              </footer>
            </section>
          </div>
        </a>
        <a class="bmd-modalButton" data-toggle="modal" data-bmdSrc="video/Business_chart_finger1.mp4"
          ...
          <div class="card x" data-aos="fade-up" data-aos-duration="2000">
            <section class="wrapper">
              <img style="background-color: #f4a919; background-image: url(images/video-bg2.jpg)" alt=""></img>
              <header class="card-title">
                <h6>Dicas</h6>
              </header>
              <footer class="card-footer  " style="background: white;">
                <h6>Mario Trentim</h6>
                <h5>Microsoft Teams e trabalho remoto</h5>
              </footer>
            </section>
          </div>
        </a>
        <a class="bmd-modalButton" data-toggle="modal" data-bmdSrc="video/Business_chart_finger1.mp4"
          ...
          <div class="card x" data-aos="fade-up" data-aos-duration="2000">
            <section class="wrapper">
              <img style="background-color: #f4a919; background-image: url(images/video-bg1.jpg)" alt=""></img>
              <header class="card-title">
                <h6>Dicas</h6>
              </header>
              <footer class="card-footer  " style="background: white;">
                <h6>Robson Camargo</h6>
                <h5>Como entender o PMBOK</h5>
              </footer>
            </section>
          </div>
        </a>
    ...
    <section class="metodos">
      <div class="container">
        <div class="row descricao">
          ...
          <div class="container">
            <div class="row white">
              <div class="col-xs-12 col-sm-6 col-md-3" data-aos="fade-up" data-aos-duration="2000">
                <ul class="pricing p-white">
                  <li class="li-pricing">
                    <big>Avaliação</big>
                  </li>
                  <li>Alinhamento de equipe</li>
                  <li>Ouvir o cliente</li>
                  <li>Ambiente de aprendizado</li>
                  <li>Diagnóstico corporativo</li>
                  <li>
              ...
              <div class="col-xs-12 col-sm-6 col-md-3" data-aos="fade-up" data-aos-duration="2000">
                <ul class="pricing p-white">
                  <li class="li-pricing">
                    <h4>Universidade Corporativa</h4>
                  </li>
                  <li>Alinhamento de equipe</li>
                  <li>Ouvir o cliente</li>
                  <li>Ambiente de aprendizado</li>
    ...
    <section class="clientes" style="padding-bottom: 3em;">
      <div class="container">
        <div class="row h-100 align-items-center">
          <div class="col">
            <h2 class="text-center text-black header-wrapper mt-0" data-aos="fade-up" data-aos-duration="1000">
            ...
            <p class="descricao-empresa" data-aos="fade-up" data-aos-duration="2000">Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque, soluta
              ...
              Mollitia vitae dolorum magni, qui ratione dolorem? Lorem ipsum, dolor sit amet consectetur adipisicing
              elit. Quo iusto culpa iste dicta voluptate quae dolorum quasi quidem! Vel quis deleniti corporis
              quibusdam omnis tempora dolores cupiditate sint harum tenetur?
            </p>
          </div>
          <div class="col" data-aos="fade-up" data-aos-duration="2000">
            <svg class="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              id="svgmap" role="img" width="460" height="465">
              <g class="model-green">
                <a class="state BA  -active" xlink:href="#modalnordeste" data-toggle="modal"
                  data-target="#modalnordeste">
                  <desc class="description">Bahia</desc>
                  <path class="shape"
                    ...
                    <path fill="#ef5411" x="365" y="216" width="70" height="70"
                  ...
                  <text class="label-state" x="365" y="216">BA</text>
                </a>
                <a class="state SE -active" xlink:href="#modalnordeste" data-toggle="modal"
                  data-target="#modalnordeste">
                  <desc class="description">Sergipe</desc>
                  <path class="shape"
                  ...
                  <circle class="icon-state" r="12" cx="425" cy="201"></circle>
                  <text class="label-state" x="418" y="205">SE</text>
                </a>
                <a class="state PE -active" xlink:href="#modalnordeste" data-toggle="modal"
                  data-target="#modalnordeste">
                  <desc class="description">Pernambuco</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="412" y="170">PE</text>
                </a>
                <a class="state AL -active" xlink:href="#modalnordeste" data-toggle="modal"
                  data-target="#modalnordeste">
                  <desc class="description">Alagoas</desc>
                  <path class="shape"
                  ...
                  <circle class="icon-state" r="12" cx="445" cy="182"></circle>
                  <text class="label-state" x="439" y="186">AL</text>
                </a>
                <a class="state AM" xlink:href="#svgmap">
                  <desc class="description">Amazonas</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="95" y="112">AM</text>
                </a>
                <a class="state PA" xlink:href="#svgmap">
                  <desc class="description">Pará</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="241" y="111">PA</text>
                </a>
                <a class="state MT " xlink:href="#svgmap" data-toggle="modal" data-target="#modalAtuation2">
                  <desc class="description">Mato Grosso</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="207" y="216">MT</text>
                </a>
                <a class="state RO " xlink:href="#svgmap">
                  <desc class="description">Rondônia</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="121" y="198">RO</text>
                </a>
                <a class="state AC" xlink:href="#svgmap">
                  <desc class="description">Acre</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="48" y="186">AC</text>
                </a>
                <a class="state AP -process" xlink:href="#svgmap">
                  <desc class="description">Amapá</desc>
                  <path id="shape-ap" class="shape"
                  ...
                  <text class="label-state" x="249" y="45">AP</text>
                </a>
                <a class="state RJ " xlink:href="#svgmap" data-toggle="modal" data-target="#modalAtuation11">
                  <desc class="description">Rio de Janeiro</desc>
                  <path class="shape"
                  ...
                  <circle class="icon-state" r="12" cx="364" cy="339"></circle>
                  <text class="label-state" x="357" y="343">RJ</text>
                </a>
                <a class="state RS -process" xlink:href="#svgmap">
                  <desc class="description">Rio Grande do Sul</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="233" y="419">RS</text>
                </a>
                <a class="state SC -process" xlink:href="#svgmap">
                  <desc class="description">Santa Catarina</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="267" y="392">SC</text>
                </a>
                <a class="state PR " xlink:href="#svgmap">
                  <desc class="description">Paraná</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="249" y="358">PR</text>
                </a>
                <a class="state SP " xlink:href="#svgmap" data-toggle="modal" data-target="#modalAtuation3">
                  <desc class="description">São Paulo</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="285" y="332">SP</text>
                </a>
                <a class="state MS " xlink:href="#svgmap" data-toggle="modal" data-target="#modalAtuation4">
                  <desc class="description">Mato Grosso do Sul</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="218" y="305">MS</text>
                </a>
                <a class="state GO " xlink:href="#svgmap" data-toggle="modal" data-target="#modalAtuation8">
                  <desc class="description">Goiás</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="267" y="268">GO</text>
                </a>
                <a class="state MG " xlink:href="#svgmap" data-toggle="modal" data-target="#modalAtuation5">
                  <desc class="description">Minas Gerais</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="331" y="288">MG</text>
                </a>
                <a class="state ES " xlink:href="#svgmap" data-toggle="modal" data-target="#modalAtuation6">
                  <desc class="description">Espírito Santo</desc>
                  <path class="shape"
                  ...
                  <circle class="icon-state" r="12" cx="391" cy="304"></circle>
                  <text class="label-state" x="384" y="308">ES</text>
                </a>
                <a class="state PI -active" xlink:href="#modalnordeste" data-toggle="modal"
                  data-target="#modalnordeste">
                  <desc class="description">Piauí</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="358" y="160">PI</text>
                </a>
                <a class="state CE  -active" xlink:href="#modalnordeste" data-toggle="modal"
                  data-target="#modalnordeste">
                  <desc class="description">Ceará</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="395" y="126">CE</text>
                </a>
                <a class="state RR" xlink:href="#svgmap">
                  <desc class="description">Roraima</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="137" y="41">RR</text>
                </a>
                <a class="state RO " xlink:href="#svgmap">
                  <desc class="description">Tocantins</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="289" y="190">TO</text>
                </a>
                <a class="state MA -active" xlink:href="#modalnordeste" data-toggle="modal"
                  data-target="#modalnordeste">
                  <desc class="description">Maranhão</desc>
                  <path class="shape"
                  ...
                  <text class="label-state" x="325" y="122">MA</text>
                </a>
                <a class="state RN -active" xlink:href="#svgmap" data-toggle="modal" data-target="#modalAtuation10">
                  <desc class="description">Rio Grande do Norte</desc>
                  <path id="shape-rn" class="shape"
                  ...
                  <circle class="icon-state" r="12" cx="442" cy="126"></circle>
                  <text class="label-state" x="434" y="130">RN</text>
                </a>
                <a class="state PB -active" xlink:href="#svgmap" data-toggle="modal" data-target="#modalAtuation7">
                  <desc class="description">Paraíba</desc>
                  <path class="shape"
                  ...
                  <circle class="icon-state" r="12" cx="448" cy="151"></circle>
                  <text class="label-state" x="441" y="155">PB</text>
                </a>
                <a class="state DF " xlink:href="#svgmap">
                  <desc class="description">Distrito Federal</desc>
                  <circle class="icon-state" r="12" cx="301" cy="251"></circle>
                  <text class="label-state" x="294" y="255">DF</text>
                </a>
              </g>
            </svg>
            <div class="circle -active" style="float: left;">
              <h6>Atuando</h6>
            </div>
  ...
  <!-- Modal Vídeo -->
  <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="clientemodal"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="clientemodal">Vídeo Institucional</h5>
  ...
  <!-- Modal Mapa dos Clientes do Nordeste -->
  <div class="modal fade" id="modalnordeste" tabindex="-1" role="dialog" aria-labelledby="clientemodal"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="clientemodal">Atuação</h5>
          <h6 class="modal-subtitle">Nordeste</h6>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <div class="col">
            <div class="clientes-img">
              <img src="images/clientes/afrafep.png" alt="" srcset="">
              <img src="images/clientes/dentalgold.png" alt="" srcset="">
              <img src="images/clientes/pactomais.png" alt="" srcset="">
              <img src="images/clientes/ppq.png" alt="" srcset="">,
              <img src="images/clientes/rommanel.png" alt="" srcset="">
              <img src="images/clientes/teccel.png" alt="" srcset="">
              <hr>
            </div>
          </div>
          <div class="col align-self-baseline">
            <div class="empresa">
              <h5 class="align-items-center justify-content-center text-center text-black header-wrapper">
                PPQ - Programa Paraibano da Qualidade
              </h5>
              <hr class="divider shadow">
              </hr>
              <p class="descricao-empresa">Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque, soluta
                eveniet suscipit provident, porro ea minus possimus eum vel doloribus laudantium non quos at quasi
                quibusdam
                reprehenderit amet facilis ullam! Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae
                asperiores quidem optio dicta, assumenda in, porro, ullam doloribus inventore quas nobis dolores iste?
            ...
            <div class="empresa">
              <h5 class="align-items-center justify-content-center text-center text-black header-wrapper">
                AFRAEP - Associação dos auditores fiscais do estado da paraíba
              </h5>
              <hr class="divider shadow">
              </hr>
              <video class="video-modal" controls>
